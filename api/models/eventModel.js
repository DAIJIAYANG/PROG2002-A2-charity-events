...
// Simple DB reads for events and categories
...
function buildWhere(filters = {}) {
  ...
  // status: upcoming/active => end >= today, past => end < today
  if (filters.status) {
  ...
  // keyword in name/description/purpose
  if (filters.q) {
...
// one event by id (ignore suspended)
